...
// incarnation per app-server generation, the foreground it currently holds,
...
// openStream opens the incarnation for the thread's current binding with an
...
// on the first record codex produced for the turn, the prompt does it when the
