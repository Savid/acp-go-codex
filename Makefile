...
docs-audit:
	...
	@for flag in -path -home -model -debug -version; do rg -q -- "$$flag" docs/reference/cli.mdx cmd/acp-go-codex/main.go || { echo "missing CLI flag in docs/code: $$flag"; exit 1; }; done
