...
// adapterHomeDir is the seam the adapter account's home is read through. It
// fills in HOME when the adapter's own process environment names none, so the
// default CODEX_HOME still resolves.
var adapterHomeDir = os.UserHomeDir
